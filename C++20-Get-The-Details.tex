...
\begin{sloppypar} %latex中一行文字出现溢出问题的解决方法
  ...
  \subsubsection*{\zihao{3} 3.2.\hspace{0.2cm}语言核心}
  \addcontentsline{toc}{subsubsection}{3.2.\hspace{0.2cm}语言核心}
  ...
  \color{white}
  \section*{\zihao{1}第三部分：一些细节}
  \pagecolor{mygray}
  \addcontentsline{toc}{section}{第三部分：一些细节}
  ...
  \subsubsection*{\zihao{3} 7.2.\hspace{0.2cm}Future的变化}
  \addcontentsline{toc}{subsubsection}{7.2.\hspace{0.2cm}Future的变化}
  ...
  \subsubsection*{\zihao{3} 10.11.\hspace{0.2cm}延迟求值}
  \addcontentsline{toc}{subsubsection}{10.11.\hspace{0.2cm}延迟求值}
  ...
  \subsubsection*{\zihao{3} 10.19.\hspace{0.2cm}并发性}
  \addcontentsline{toc}{subsubsection}{10.19.\hspace{0.2cm}并发性}
  ...
  \subsubsection*{\zihao{3} 10.25.\hspace{0.2cm}半Regular}
  \addcontentsline{toc}{subsubsection}{10.25.\hspace{0.2cm}半Regular}
  ...
  \subsubsection*{\zihao{3} 10.28.\hspace{0.2cm}六大构造函数}
  \addcontentsline{toc}{subsubsection}{10.28.\hspace{0.2cm}六大构造函数}
