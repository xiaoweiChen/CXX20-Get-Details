...
\subsubsubsection{5.2.2\hspace{0.2cm}自动推断连续对象序列的长度}

与C数组相反，std::span<T>可以自动推断对象连续序列的长度。
...
\subsubsubsection{5.2.3\hspace{0.2cm}用指针和长度值来创建std::span}
...
其实，有很多方便的函数可以用来处理std::span的元素。

\subsubsubsection{5.2.5\hspace{0.2cm}处理std::span中的元素}
