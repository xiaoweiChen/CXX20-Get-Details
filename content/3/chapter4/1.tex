...
\subsubsubsection{4.1.1\hspace{0.2cm} Two Wrong Approaches}
...
\noindent
4.1.1.1\hspace{0.2cm} Too Specific
...
\noindent
4.1.1.1.1\hspace{0.2cm}Narrowing Conversion
...
\noindent
4.1.1.1.2\hspace{0.2cm}Integral Promotion
...
Lines 6 - 12 are the crucial ones in this screenshot of \href{https://cppinsights.io/}{C++ Insights}. The template instantiation of the function template add creates a full specialization with the return type int. Both bools are implicitly promoted to int.
...
\noindent
4.1.1.2\hspace{0.2cm} Too Generic
...
\noindent
4.1.1.3\hspace{0.2cm} Concepts to the Rescue
...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Tip Headline]
